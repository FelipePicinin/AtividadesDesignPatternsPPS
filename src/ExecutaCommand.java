...
public class ExecutaCommand {
    ...
    public static void go() {
        ...
        sequencia.empilharComando(new VenderProduto(produto1, 9));
        ...
        sequencia.empilharComando(new ZerarEstoque(produto1, 0));
        sequencia.empilharComando(new ZerarEstoque(produto2, 0));
        sequencia.empilharComando(new ZerarEstoque(produto3, 0));
